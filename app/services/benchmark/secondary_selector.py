"""
secondary_selector.py

Benchmark 3 — Secondary

Selection criteria:
  - is_cleaned = False AND is_outlier = False
  - price_percentile <= B3_PCT_MAX (default 25%)
  - road_width_m < city_road_median (strictly narrower than city median road)
  - area_category in ("Small", "Medium")
...
class SecondarySelector:
    """Benchmark 3 — lower price band, narrower road than city median, small/medium area."""

    BENCHMARK_TYPE = "secondary"
